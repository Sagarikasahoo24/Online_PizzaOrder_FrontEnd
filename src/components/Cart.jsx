...
const Cart = () => {
  ...
  return (
    <>
      <div className={`fixed right-0 top-0 w-full lg:w-[22vw]
         h-full bg-white p-5 mb-3 ${
       ...
       <div className='flex justify-between items-center my-3'>
        ...
        className='border-2 border-gray-600 font-bold p-1 text-xl rounded-md
      ...
      {cartItems.length>0? cartItems.map((food)=>{
       ...
       <div className='absolute bottom-0'>
        ...
        <button 
           ...
           className='bg-green-500 font-bold px-3
         text-white py-2 
      ...
      className= {`bg-white 
      rounded-full shadow-md text-5xl p-3
